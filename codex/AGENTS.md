...
- Start from literal evidence, separate observations from hypotheses, choose the minimum sufficient modality, and translate it back into engineering terms with uncertainty and a falsifier; include a next move when material.
