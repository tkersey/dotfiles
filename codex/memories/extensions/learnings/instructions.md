...
A note is authoritative that a specific canonical row should be considered by Phase 2. It is not a replacement for the row and not a runtime instruction.
...
Never mutate or delete source notes or `.learnings.jsonl`.
