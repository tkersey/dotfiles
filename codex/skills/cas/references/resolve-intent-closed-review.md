# Intent-Closed `$resolve` Review Lanes

CAS carries review transport; `resolve-c3` owns review-batch authority.
...
CAS receipts should preserve mode, horizon, batch, aperture, and tuple metadata so `resolve-c3` and `$seq` can validate lineage.
