...
privatization, decommissioning, canonicalization, and refactor probes, then prove
that the added surface reduces total semantic surface.
...
6. decommission expired compatibility or scaffold paths
