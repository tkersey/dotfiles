...
for token in (
    ...
    "This hardened standalone contract requires Ledger 0.7.0 or newer.",
    "ledger --version",
...
required_cases = {
    ...
    "Run the source-memory checkpoint for a completed implementation whose evidence packet contains no failed or abandoned route.": True,
    "Run the source-memory checkpoint after the benchmark-regressing route was reverted and a narrower route passed.": True,
