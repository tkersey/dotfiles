...
- terminal handoff or closeout with no failed-route semantics.
...
6. Did the `route-gate` projection and memory-note admission fail closed rather than project malformed authority?
