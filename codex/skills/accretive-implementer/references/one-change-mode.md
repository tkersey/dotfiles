...
- Prefer the highest-leverage right-sized accretive change.
- A no-code proof, deletion, collapse, canonicalization, or existing-owner mutation may beat adding code.
- Prefer a change that improves correctness, soundness, reviewability, misuse resistance, or surface reduction before style or taste.
...
- the chosen route
- the chosen change or no-change proof
- why it dominates
- the narrowest cut
- the surface delta
- the proof signal
