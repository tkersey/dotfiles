...
- prefer no-change or validate-only when mutation authority is stale or proof is missing
- preserve public/wire/storage contracts unless explicit authority says otherwise
...
- prefer stronger construction over downstream defensive branches
