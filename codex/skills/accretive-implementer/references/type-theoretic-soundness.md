...
- no-code proof that the current owner already enforces the property
...
If the proposed fix adds downstream defensive branches, ask whether a stronger upstream constructor, schema, parser, or owner boundary can make those branches unnecessary.
