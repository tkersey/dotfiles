...
`$ideate` is a mode-aware opportunity compiler. It combines repository signal harvesting, candidate generation, ruthless winnowing, Metanoetic/Glaze prompt passes, overlap checking, and a planning handoff seed when evidence is sufficient.
...
The preliminary leader is not final. It is input to Metanoetic and Glaze.
...
- standard/deep: at least 5 passes — value, architecture risk, evidence/originality, Metanoetic delta, Glaze cash-out;
