...
- Repeated attempts fail in the same way 🔁.
- The user asks for new angles, options, or "outside the box" ideas 💡.
...
- Need user-centric clarity → Design Thinking + Storyboard.
- Need reframes → Lateral Thinking / Random Stimulus / Forced Connections.
