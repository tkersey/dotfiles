...
class ReviewFoldContractTests(unittest.TestCase):
    ...
    def test_single_finding_cas_prose_needs_fresh_receipts(self) -> None:
        skill_required = [
            ...
            "fix",
            "next mutation",
            "Treat single or small-batch CAS prose like `CAS attempt found a P1/P2`, `CAS attempt returned P1/P2 findings`, `CAS found valid items`, `CAS found one remaining valid P1/P2`, `CAS attempt returned another accepted P1/P2`, `the finding is valid`, `this finding is valid too`, `CAS is right`, `accepted code-change liabilities`, `the owner fix is`, `owner-correct fix is`, `the clean fix is`, `concrete gaps remain`, `gaps remain`, `clean streak stays at 0`, or `streak remains 0` as receipt-triggering folds",
        ...
        contract_required = [
            "review-fold-v1.4.16-gaps-remain-pattern",
