...
class ReviewFoldContractTests(unittest.TestCase):
    ...
    def test_single_finding_cas_prose_needs_fresh_receipts(self) -> None:
        skill_required = [
            ...
            "review-thread sweep is still clean",
        ...
        contract_required = [
            "review-fold-v1.4.26-new-p2-acceptance-reset",
            ...
            "valid finding batches have a receipt before repair planning",
            ...
            "CAS attempt found a new P1 or P2 without a receipt",
            ...
            "review-thread sweep is still clean without a receipt",
            ...
            "accepting it prose precedes receipt",
            ...
            "starting fresh CAS attempt without a receipt",
            "clean streak is reset without a receipt",
            "clean streak resets again without a receipt",
