...
class ReviewFoldContractTests(unittest.TestCase):
    ...
    def test_single_finding_cas_prose_needs_fresh_receipts(self) -> None:
        skill_required = [
            ...
            "Treat single or small-batch CAS prose like `CAS attempt found a P1/P2`, `CAS attempt returned P1/P2 findings`, `CAS found one remaining valid P1/P2`, `the finding is valid`, `this finding is valid too`, `accepted code-change liabilities`, `the owner fix is`, `owner-correct fix is`, `clean streak stays at 0`, or `streak remains 0` as receipt-triggering folds",
        ...
        contract_required = [
            "review-fold-v1.4.8-cas-returned-finding-patterns",
