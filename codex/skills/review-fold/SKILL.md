...
resolved`, `PR thread sweep is clean`, `no unresolved threads`, `unresolved
thread count is 0`, and `no unresolved threads across both pages` as
...
15. Treat clean CAS-run prose like `CAS attempt ... is clean`, `clean streak is N/3`, `clean streak is 1/3`, or `starting fresh attempt N` as receipt-triggering clean-run accounting before advancing the closeout loop.
