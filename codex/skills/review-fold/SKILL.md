...
findings`, `CAS returned one current-head P1/P2 finding`, `CAS returned ... valid findings`, `CAS found ... valid items`, `CAS found ... valid classes`, `CAS
...
streak is reset`, `clean streak resets to zero`, `clean streak resets to 0`,
or `streak remains 0`.
