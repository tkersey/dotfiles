...
`CAS attempt ... found ... P1/P2`, `CAS found one remaining valid P1/P2`, `the
finding is valid`, `this finding is valid too`, `the owner fix is`,
`owner-correct fix is`, `clean streak stays at 0`, or `streak remains 0`.
