...
Every policy digest binds the complete canonical EPG candidate, including:
...
each final pass evaluates the complete architecture-policy pair
...
The final nine lens identifiers remain unchanged for compatibility. Their semantics
are lifted over architecture and policy as defined by
[policy-synthesis-fixed-point.md](policy-synthesis-fixed-point.md).
...
change may delete actions or factors while still being accretive because
justification, observation preservation, and proof strength increase.
