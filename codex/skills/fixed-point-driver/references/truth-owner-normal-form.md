# Truth-Owner Normal Form

A changeset reaches Truth-Owner Normal Form when:

- every material invariant has one canonical owner;
- witnesses point back to that owner;
