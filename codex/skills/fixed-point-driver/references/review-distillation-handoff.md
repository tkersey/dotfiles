# Review Distillation Handoff

For `review_distillation_packet`:

- Treat review lab diffs as evidence, not delivery design.
- Rebuild the selected normal form from the delivery base.
