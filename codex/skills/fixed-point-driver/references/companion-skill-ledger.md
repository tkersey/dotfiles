...
Do not mark `review-compression-compiler` as used unless RCP/RDP or root-equivalent structured packet exists.
Do not mark `negative-ledger` as no-applicable-evidence unless a query/map pass or root-equivalent pass was actually performed.
