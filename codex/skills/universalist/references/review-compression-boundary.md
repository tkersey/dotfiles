...
If a prior `universalist_check.decision: not-needed` was falsified by same-cluster recurrence, the boundary packet must explicitly explain why a boundary artifact remains unnecessary or select `climb` / `blocked`.
