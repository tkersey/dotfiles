# Universalist Check in Resolve

Require `universalist_check` when:
...
If decision is `use-universalist`, obtain `$universalist` output or root-equivalent `universal_boundary_packet` before mutation.
