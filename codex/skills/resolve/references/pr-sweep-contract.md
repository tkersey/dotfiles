...
Mutation-capable routes go through the Review-Closure Abstraction Ladder and Cluster Normalization Checkpoint when applicable before `$fixed-point-driver`.
