...
[cli-tools.md](references/cli-tools.md) for the Zig marker compatibility checks,
...
[report template](assets/perf-report-template.md) for a requested full report.
