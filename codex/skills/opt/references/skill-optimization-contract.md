...
- Add validation commands or deterministic sanity scripts.
- Preserve concrete receipts from CAS, Shadow, Tune, or worktree validation.
...
- Marking a goal complete without validating every requirement.
...
- Use scripts only for deterministic checks that natural-language instructions handle poorly.
...
- Collapsing audit, proposal, apply, validate, and ship into one ambiguous mode.
